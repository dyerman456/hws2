...
const HW6 = () => {
    ...
    const restore = () => {
        // let localSorageValue = localStorage.getItem("hw6-editable-span-value")
        // if (typeof(localSorageValue) === "string") {
        //     setValue(localStorage.getItem("hw6-editable-span-value"))
        // }
        // // делают студенты
